...
task_type=wiki_5ways
eva_data_path=/home/cjz/SFTonGFM/data/wikics/test_5ways.json
eva_log_path=/home/cjz/SFTonGFM/output_eva_wopre_wiki

arr=(5 50 20)

for i in "${arr[@]}"
do
    data_path="/home/cjz/SFTonGFM/data/wikics/train_${i}shots_5ways.json"
    output_dir="/home/cjz/SFTonGFM/checkpoints/wopretrain/wiki_5_way_${i}_shots"
...
for i in "${arr[@]}"
do
    eva_path="/home/cjz/SFTonGFM/checkpoints/wopretrain/wiki_5_way_${i}_shots"
